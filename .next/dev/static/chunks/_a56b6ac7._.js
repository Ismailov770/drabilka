...
"[project]/app/owner-dashboard/production/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OwnerProductionPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OwnerProductionPage.useEffect": ()=>{
            let cancelled = false;
            const fetchProduction = {
                "OwnerProductionPage.useEffect.fetchProduction": async ()=>{
                    setIsLoading(true);
                    setError(null);
                    try {
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$styles$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["get"])("/production/batches", {
                            params: {
            ...
            }["OwnerProductionPage.useEffect.fetchProduction"];
            fetchProduction();
            return ({
                "OwnerProductionPage.useEffect": ()=>{
                    cancelled = true;
    ...
    const filteredRecords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OwnerProductionPage.useMemo[filteredRecords]": ()=>records.filter({
                "OwnerProductionPage.useMemo[filteredRecords]": (record)=>{
            ...
            }["OwnerProductionPage.useMemo[filteredRecords]"]).map({
                "OwnerProductionPage.useMemo[filteredRecords]": (record)=>({
                        ...record,
                        totalSum: record.quantity * record.price
                    })
            }["OwnerProductionPage.useMemo[filteredRecords]"])
    }["OwnerProductionPage.useMemo[filteredRecords]"], [
        records,
        filters.product,
        filters.shift,
...
_s(OwnerProductionPage, "hw9u/NOIMs8WYtgajdQdsbeVmb0=");
_c = OwnerProductionPage;
var _c;
__turbopack_context__.k.register(_c, "OwnerProductionPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a56b6ac7._.js.map